...
mod tests {
    ...
    fn test_insert_and_get_person() {
        ...
        let person_id = arena.insert(Person {
    ...
    fn test_reuse_slots_person() {
        let mut arena = Arena::new();
        let person_id1 = arena.insert(Person {
            name: "Alice".to_string(),
        });
        arena.remove(&person_id1);

        let person_id2 = arena.insert(Person {
            name: "Bob".to_string(),
        });
    ...
    fn test_reuse_slots_car() {
        let mut arena = Arena::new();
        let car_id1 = arena.insert(Car {
            model: "Tesla Model 3".to_string(),
        });
        arena.remove(&car_id1);

        let car_id2 = arena.insert(Car {
            model: "Ford Mustang".to_string(),
        });
    ...
    fn test_arena_with_struct() {
        ...
        let id1 = arena.insert(TestStruct {
            name: "Item 1".to_string(),
            value: 10,
        });
        let id2 = arena.insert(TestStruct {
            name: "Item 2".to_string(),
            value: 20,
        });
        let id3 = arena.insert(TestStruct {
        ...
        assert_eq!(
            id_map
                .entry(ArenaId::<TestStruct>::new(100))
                .or_insert("New"),
            &"New"
        );
