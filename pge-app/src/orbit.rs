...
impl OrbitController {
    ...
    pub fn has_pending_input(&self) -> bool {
        self.orbit_delta != Vec2::ZERO || self.pan_delta != Vec2::ZERO || self.zoom_delta != 0.0
    }
...
mod tests {
    ...
    fn orbit_controller_updates_node() {
        ...
        let expected_pos =
            controller.target - (controller.rotation * Vec3::Z) * controller.distance;
